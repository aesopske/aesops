...
async function DataDigestItem({ params }) {
    ...
    return (
        <div className='min-h-screen xl:py-10'>
            <div className='relative w-full bg-brandaccent-50 overflow-hidden md:max-w-screen-xl 2xl:max-w-screen-2xl md:mx-auto xl:rounded-lg lg:h-96 2xl:px-0'>
                <Image
            ...
            <div className='px-4 space-y-5 max-w-screen-xl mx-auto py-10 2xl:px-0 2xl:max-w-screen-2xl'>
