...
function HasBackgroundWrapper({
    ...
    return (
        <div
            ...
            {...props}>
            <div className='absolute -left-5 -top-20 p-20  w-28 h-28  rounded-full bg-brand-background md:left-0 md:-top-24 md:w-32 md:h-32 md:p-24'>
            ...
            <div className='absolute -right-5 -bottom-20 w-28 h-28 rounded-full p-20 bg-brand-background md:w-32 md:h-32 md:p-24 md:-bottom-24 md:right-0'>
