...
function Navbar() {
    ...
    return (
        <header className='sticky inset-x-0 top-0 z-50 text-aes-dark border-b border-aes-light bg-brand-background h-fit md:max-h-20'>
            <nav
                className='flex items-center justify-between px-5 py-2 container-fluid max-w-screen-xl mx-auto h-full border-b border-aes-light md:border-none lg:py-4 xl:px-0'
                aria-label='Global'>
                <Logo />
