...
import AboutMember from '@apps/web/src/components/common/organisms/about-author/AboutAuthor'
...
import { AUTHOR, PAGE, SECTION, VALUE } from '@apps/web/sanity/utils/types'
