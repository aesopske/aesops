...
function TalkToUs() {
    return (
        <section
            id='subscribe'
            className='bg-brandprimary-700 h-auto pb-10 container mx-auto max-w-(--breakpoint-lg) lg:max-w-(--breakpoint-xl) 2xl:max-w-(--breakpoint-2xl) grid grid-cols-1 md:grid-cols-2 gap-5 p-0 md:h-96 md:pb-0 xl:rounded-3xl'>
