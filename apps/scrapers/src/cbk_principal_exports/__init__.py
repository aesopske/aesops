...
EXPORTS_PAGE_URL = "https://www.centralbank.go.ke/principal-exports-volume-value-unit-prices/"
AJAX_URL = "https://www.centralbank.go.ke/wp-admin/admin-ajax.php"
TABLE_ID = "27"  # "Principal Exports: Volume, Value and Unit Prices (Ksh Million)" wpDataTable
# on EXPORTS_PAGE_URL
...
# year, month, then {volume,value,average} x {coffee,tea,hort}.
_SSP_BODY = {
    "draw": "1",
    "start": "0",
    "length": "-1",
