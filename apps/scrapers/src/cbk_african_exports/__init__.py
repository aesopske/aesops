...
AFRICAN_EXPORTS_PAGE_URL = "https://www.centralbank.go.ke/value-exports-selected-african-countries/"
AJAX_URL = "https://www.centralbank.go.ke/wp-admin/admin-ajax.php"
TABLE_ID = "23"  # "Value of Exports to Selected African Countries (Ksh Million)" wpDataTable
# on AFRICAN_EXPORTS_PAGE_URL
...
_HEADERS = {
    ...
    "Referer": AFRICAN_EXPORTS_PAGE_URL,
...
# year, month, then 10 country columns, Other, Total.
_SSP_BODY = {
    "draw": "1",
    "start": "0",
    "length": "-1",
