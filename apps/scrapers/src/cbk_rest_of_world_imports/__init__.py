...
ROW_IMPORTS_PAGE_URL = "https://www.centralbank.go.ke/value-direct-imports-selected-rest-world-countries/"
AJAX_URL = "https://www.centralbank.go.ke/wp-admin/admin-ajax.php"
TABLE_ID = "21"  # "Value of Direct Imports from Selected Rest of World Countries (Kshs.
# Millions)" wpDataTable on ROW_IMPORTS_PAGE_URL
...
# year, month, then 11 country columns, Others, Total.
_SSP_BODY = {
    "draw": "1",
    "start": "0",
    "length": "-1",
